      ...
      <div className="container mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-slate-900 mb-4">
            {config.section_title.includes("seu negócio")
              ? <>{config.section_title.split("seu negócio")[0]}<span className="text-orange-500">seu negócio</span></>
              : config.section_title}
          </h2>
          <p className="text-slate-600">{config.section_subtitle}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {config.plans.map((plan) => (
            ...
            >
              ...
              {plan.best_value && !plan.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-sm font-semibold bg-green-500 text-white">
                  Melhor Valor
                </div>
              )}
              ...
              <div className="mb-4">
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-sm text-slate-500">/{plan.price_label}</span>
                </div>
                <p className="text-xs text-green-600 font-medium mt-1">{plan.trial_note}</p>
              </div>
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <div className="rounded-2xl border p-6 lg:p-8" style={{ background: "linear-gradient(145deg, hsl(230 30% 13%), hsl(230 30% 9%))", borderColor: "hsl(0 0% 100% / 0.07)" }}>
            <div className="text-center mb-8">
              <h3 className="font-display text-xl font-bold mb-2" style={{ color: "hsl(0 0% 95%)" }}>
                "{config.fees_subtitle}"
              </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="rounded-xl p-4 text-center" style={{ background: "hsl(160 84% 39% / 0.06)", border: "1px solid hsl(160 84% 39% / 0.15)" }}>
                ...
                <div className="border-t pt-2" style={{ borderColor: "hsl(0 0% 100% / 0.06)" }}>
                  <span className="font-display text-xl font-black" style={{ color: "hsl(160 84% 55%)" }}>{config.fees.pix_rate}</span>
              ...
              <div className="rounded-xl p-4 text-center" style={{ background: "hsl(262 83% 58% / 0.06)", border: "1px solid hsl(262 83% 58% / 0.15)" }}>
                ...
                <div className="border-t pt-2" style={{ borderColor: "hsl(0 0% 100% / 0.06)" }}>
                  <span className="font-display text-xl font-black" style={{ color: "hsl(262 83% 68%)" }}>{config.fees.credit_rate}</span>
              ...
              <div className="rounded-xl p-4 text-center" style={{ background: "hsl(192 91% 42% / 0.06)", border: "1px solid hsl(192 91% 42% / 0.15)" }}>
                ...
                <div className="border-t pt-2" style={{ borderColor: "hsl(0 0% 100% / 0.06)" }}>
                  <span className="font-display text-xl font-black" style={{ color: "hsl(192 91% 55%)" }}>{config.fees.debit_rate}</span>
                  <p className="text-xs" style={{ color: "hsl(220 15% 55%)" }}>{t("total_per_transaction")}</p>
                </div>
              </div>
            </div>
