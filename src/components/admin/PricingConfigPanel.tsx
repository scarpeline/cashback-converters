...
const DEFAULT_PLANS: PricingPlan[] = [
  {
    ...
    price: "29,90",
    price_label: "por mês",
    trial_note: "Primeiro mês por R$19,90",
    popular: false,
    best_value: false,
  ...
  },
  {
    ...
    price: "79,90",
    price_label: "por 3 meses",
    trial_note: "Equivale a R$26,63/mês",
    popular: true,
    best_value: false,
  ...
  },
  {
    ...
    price: "199,90",
    price_label: "por ano",
    trial_note: "Equivale a R$16,65/mês",
    popular: false,
    best_value: true,
...
export const PRICING_DEFAULTS: PricingConfig = {
  ...
  section_subtitle: "7 dias grátis em todos os planos. Sem cartão de crédito. Cancele quando quiser.",
