      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 lg:p-6 overflow-auto">
          <Routes>
            ...
            <Route path="relatorios" element={<ReportsPanel barbershopId={mainBarbershop?.id || ''} />} />
            <Route path="fila-espera" element={<ProfessionalWaitlistPanel barbershopId={mainBarbershop?.id || ''} />} />
            ...
            <Route path="marketing-empresarial" element={
              <div className="p-6"><MarketingEmpresarial isOwner={true} /></div>
            } />
            ...
            <Route path="whatsapp-pacotes" element={<MessagePackagesPanel barbershopId={mainBarbershop?.id || ''} />} />
            <Route path="whatsapp-custos" element={<CostSplitConfigPanel barbershopId={mainBarbershop?.id || ''} />} />
            <Route path="whatsapp-relatorios" element={<MessageReportsPanel barbershopId={mainBarbershop?.id || ''} />} />
            <Route path="whatsapp-monitor" element={<WhatsAppMonitoringPanel barbershopId={mainBarbershop?.id || ''} />} />
            <Route path="assistente-ia" element={<AIAudioConfigPanel barbershopId={mainBarbershop?.id || ''} />} />
            <Route path="avaliacoes" element={<ClientReviewsPanel barbershopId={mainBarbershop?.id || ''} />} />
            <Route path="fidelidade" element={<LoyaltyPanel barbershopId={mainBarbershop?.id || ''} isOwner={true} />} />
            <Route path="ciclo-mensagens" element={<WeeklySchedulePanel barbershopId={mainBarbershop?.id || ''} />} />
