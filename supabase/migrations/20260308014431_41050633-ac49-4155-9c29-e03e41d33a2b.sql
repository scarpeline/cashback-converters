...
-- RESTRICTIVE = AND logic (user must match ALL policies)
-- PERMISSIVE = OR logic (user must match ANY policy)
-- =============================================
...
CREATE POLICY "Super admins can manage roles" ON public.user_roles FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all barbershops" ON public.barbershops FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all professionals" ON public.professionals FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all notifications" ON public.notifications FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all affiliates" ON public.affiliates FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage accountants" ON public.accountants FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all fiscal records" ON public.fiscal_records FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all chats" ON public.support_chats FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all messages" ON public.support_messages FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all pixels" ON public.pixels FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can manage all pixel configs" ON public.pixel_configurations FOR ALL TO authenticated USING (is_super_admin(auth.uid()));

-- ========== INTEGRATIONS ==========
DROP POLICY IF EXISTS "Super admins can manage integrations" ON public.integrations;
CREATE POLICY "Super admins can manage integrations" ON public.integrations FOR ALL TO authenticated USING (is_super_admin(auth.uid()));

-- ========== INTEGRATION_SETTINGS ==========
DROP POLICY IF EXISTS "Super admins can manage integration settings" ON public.integration_settings;
CREATE POLICY "Super admins can manage integration settings" ON public.integration_settings FOR ALL TO authenticated USING (is_super_admin(auth.uid()));

-- ========== INTEGRATION_ENDPOINTS ==========
DROP POLICY IF EXISTS "Super admins can manage endpoints" ON public.integration_endpoints;
CREATE POLICY "Super admins can manage endpoints" ON public.integration_endpoints FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can view integration logs" ON public.integration_logs FOR SELECT TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can view webhook logs" ON public.webhooks_log FOR SELECT TO authenticated USING (is_super_admin(auth.uid()));
CREATE POLICY "System can insert webhook logs" ON public.webhooks_log FOR INSERT WITH CHECK (true);

-- ========== JOB_QUEUE ==========
DROP POLICY IF EXISTS "Super admins can manage job queue" ON public.job_queue;
...
CREATE POLICY "Super admins can manage job queue" ON public.job_queue FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
CREATE POLICY "System can insert jobs" ON public.job_queue FOR INSERT WITH CHECK (true);
CREATE POLICY "System can update jobs" ON public.job_queue FOR UPDATE USING (true);

-- ========== API_KEYS_CUSTOM ==========
DROP POLICY IF EXISTS "Super admins can manage all api keys" ON public.api_keys_custom;
CREATE POLICY "Super admins can manage all api keys" ON public.api_keys_custom FOR ALL TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "Super admins can view app environment" ON public.app_environment FOR SELECT TO authenticated USING (is_super_admin(auth.uid()));
CREATE POLICY "Super admins can update app environment" ON public.app_environment FOR UPDATE TO authenticated USING (is_super_admin(auth.uid()));
...
CREATE POLICY "System can manage rate limits" ON public.rate_limits FOR ALL USING (true) WITH CHECK (true);
